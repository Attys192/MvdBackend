...
namespace MvdBackend.Migrations
{
    ...
    [Migration("20251029122306_SplitAiAnalysisToSeparateTable")]
    partial class SplitAiAnalysisToSeparateTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MvdBackend.Models.CitizenRequestAnalysis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CitizenRequestAnalyses");
                });
            ...
            modelBuilder.Entity("MvdBackend.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MvdBackend.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MvdBackend.Models.CitizenRequestAnalysis", b =>
                {
                    b.HasOne("MvdBackend.Models.CitizenRequest", "CitizenRequest")
                        .WithOne("Analysis")
                        .HasForeignKey("MvdBackend.Models.CitizenRequestAnalysis", "CitizenRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MvdBackend.Models.User", b =>
                {
                    b.HasOne("MvdBackend.Models.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MvdBackend.Models.Role", "Role")
                        .WithMany("Users")
